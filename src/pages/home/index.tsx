                     ...
                     <div className="hover:bg-secondary/50 rounded-xl border p-4 transition-colors duration-300 ease-in-out">
                        {
                           isCurrentSong(currentSong) ? (
                              <div className='transition-colors duration-300 ease-in-out flex items-end gap-4 sm:flex-row'>
                                 <div className='max-w-24 sm:shrink-0'>
                                 ...
                                 <div className='grow'>
                                    <a href={currentSong?.item.external_urls.spotify} target="_blank" className="text-foreground hover:underline transition-colors duration-300 ease-in-out text-lg font-medium">{currentSong?.item.name}</a>
                                    <p className="text-muted-foreground text-sm">{currentSong?.item.artists.map(artist => artist.name).join(', ')}</p>
