...
function Profile({ profile }: Props) {
  ...
  return (
    <div className="rounded-lg border bg-[hsl(var(--bg-card))] text-[hsl(var(--text-foreground))] shadow-md">
      <div className="p-6 pt-0 mt-5">
        <div className="flex flex-row items-center">
          <img src={`https://cdn.discordapp.com/avatars/${import.meta.env.VITE_PROFILE_ID}/${profile?.discord_user?.avatar}.png`} alt="its_me" width={100} height={100} loading='eager' decoding='async' className='rounded-xl' />
          <div className="ml-4 flex flex-col gpa-y-1">
            ...
            <h1 className="text-2xl font-['Geist-Bold'] text-[hsl(var(--text-primary))]">{import.meta.env.VITE_GLOBAL_NAME}</h1>
        ...
        <div className="mt-5 flex max-w-[65.43075245365321vh] flex-wrap gap-2 rounded-xl bg-[hsl(var(--bg-primary))] p-3">
          ...
          <div className="flex flex-row items-center gap-1 rounded-md bg-[hsl(var(--bg-secondary))]/60 py-1 pl-3 pr-4 transition duration-300 max-md:grow">
            ...
            <p className="text-sm font-['Geist-Semibold'] text-gray-400">+192 Coffee</p>
          </div>
          <div className="flex flex-row items-center gap-1 rounded-md bg-[hsl(var(--bg-secondary))]/60 py-1 pl-3 pr-4 transition duration-300 max-md:grow">
        ...
        <div className='mt-5 flex flex-row items-center gap-2'>
          ...
          <a href={`https://github.com/${import.meta.env.VITE_GITHUB_USERNAME}`} className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-['Geist-Medium'] ring-offset-[hsl(var(--bg-secondary))] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 bg-[hsl(var(--bg-secondary))] text-[hsl(var(--text-foreground))] hover:bg-[hsl(var(--bg-secondary))]/90 h-10 px-4 py-2 w-full gap-2">
